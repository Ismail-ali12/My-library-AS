...
public class FavouriteBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView favouriteBooksRec = findViewById(R.id.favouriteBooksRec);
        BookRecViewAdapter adapter = new BookRecViewAdapter(this, "favouriteBooks");
        favouriteBooksRec.setAdapter(adapter);
        favouriteBooksRec.setLayoutManager(new LinearLayoutManager(this));
